#!/bin/bash
# This is the Ragnarok Compiler Menu System v1.0 
## ----------------------------------
# Define variables
# ----------------------------------
EDITOR=vim
...
# Get Ragnarok Github Source Function
get_ragnacoin(){
	clear
	echo " Cloning Ragnarok Source from Master Branch..."
	cd /home/ragna/Desktop
	git clone https://github.com/ragnaproject/Ragnarok.git
	echo " Check for Errors before continuing "
    pause
}

# Update Ragnarok Github Source Function
update_ragnacoin(){
	clear
	echo " Updating Ragnarok Source from Master Branch..."
	cd /home/ragna/Desktop/Ragnarok
	git pull
	echo " Check for Errors before continuing "
    pause
}
...
install_3rdparty(){
	...
	cd /home/ragna/Desktop/
	wget https://github.com/mrgrow2k/deps/releases/download/1.0.2d/openssl-1.0.2b.tar.gz
	...
	cd /home/ragna/Desktop/
	wget https://github.com/mrgrow2k/deps/releases/download/4.8.30/db-4.8.30.NC.tar.gz
	tar zxvf db-4.8.30.NC.tar.gz
	cd /home/ragna/Desktop/db-4.8.30.NC
	make clean
	wget https://raw.githubusercontent.com/mrgrow2k/deps/master/berekeydb-4.8.30.sh
	export PATH=/mnt/mxe/usr/bin:$PATH
	export PATH=$MXEPATH/bin:$PATH
	dos2unix berekeydb-4.8.30.sh
	chmod ugo+x /home/ragna/Desktop/db-4.8.30/berekeydb-4.8.30.sh
	sudo /home/ragna/Desktop/db-4.8.30/./berekeydb-4.8.30.sh
	echo " Check for Errors before continuing "
	pause
...
windows_qt(){
	...
	export PATH=/mnt/mxe/usr/bin:$PATH
	export PATH=$MXEPATH/bin:$PATH
	/mnt/mxe/usr/i686-w64-mingw32.static/qt5/bin/qmake Ragnarok.pro
	make -j4
	pause
}
...
build_win(){
	clear
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
	echo "    Ragnarok Windows Build Menu "
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
...
build_linux(){
	clear
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
	echo "    Ragnarok Linux Build Menu "
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
...
build_macos(){
	clear
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
	echo "    Ragnarok MacOS Build Menu "
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
...
show_menus() {
	...
	echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
	echo "                                                                                 
	cat << "EOF"  < Fear the EOF          Ragnarok Installer Ver 1.0
                    _.-,                   
               _ .-'  / .._              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            .-:'/ - - \:::::-.
    ...
    .  :::.'       -  .::::'_   _.:      we need to compile Ragnarok.
  .-''---' .'|      .::::'   '''::::     
 '. ..-:::'  |    .::::'        ::::     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  '.' ::::    \ .::::'          ::::
       ::::   .::::'           ::::      Supported Builds:
